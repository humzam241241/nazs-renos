...
const testimonials = [
  {
    quote:
      "Naz's Renos transformed our dated kitchen into a stunning modern masterpiece. The attention to detail was extraordinary -- from the custom millwork to the hidden lighting. We couldn't be happier.",
